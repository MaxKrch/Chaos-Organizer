...
export default class ModalRecordMedia extends Modal {
  ...
  #renderElement(data) {
    ...
    this.body.classList.add(
      `modal__body`,
      `stream-media-upload-error__container`,
    );
  ...
  #renderTitleElement(data) {
    ...
    this.staticElements.title.classList.add(
      ...
      `stream-media-upload-error__title`,
    );
  ...
  #renderDescriptionElement(data) {
    ...
    this.staticElements.description.classList.add(
      `modal__description`,
      `stream-media-upload-error__section`,
      `stream-media-upload-error__description`,
    );
  ...
  #renderMediaBlock(data) {
    ...
    this.staticElements.media.container.classList.add(
      `stream-media-upload-error__section`,
      `stream-media-upload-error__video`,
    );
    ...
    this.staticElements.media.file.classList.add(
      `stream-media-upload-error__video-file`,
    );
  ...
  #renderButtonsBlock(data) {
    ...
    this.staticElements.buttons.container.classList.add(
      `modal__buttons`,
      `stream-media-upload-error__section`,
      `stream-media-upload-error__buttons`,
    );
    ...
    if (data.type === `errorRecord`) {
      ...
      this.staticElements.buttons.close.classList.add(
        `button`,
        `stream-media-upload-error__button`,
      );
    ...
    if (data.type === `cantSaveMedia`) {
      ...
      this.staticElements.buttons.remove.classList.add(
        `button`,
        `stream-media-upload-error__button`,
      );
      ...
      this.staticElements.buttons.download.classList.add(
        `button`,
        `stream-media-upload-error__button`,
      );
      ...
      this.staticElements.buttons.download.dataset.fileName =
        this.file.file.name;
